...
$homepage_banner = get_option('sartorello_woo_theme_homepage_banner');
?>
...
<main>
    ...
    <section class="mx-auto flex h-20 max-w-1440px items-center justify-center px-4 text-center sm:px-6 lg:px-8">
        <p class="inline-block rounded-sm bg-neutral-900 px-6 py-2 text-sm font-light text-white">
            <span class="font-bold">5% OFF</span> com o cupom <span class="font-bold">PRIMEIRACOMPRA</span> &bull;
    ...
    <section x-data="{}" class="mx-auto max-w-1440px px-4 sm:px-6 lg:px-8 py-10">
        ...
        <?php wc_get_template('components/featured-categories.php'); ?>
    </section>
    ...
    <section x-data="{}" class="mx-auto max-w-1440px px-4 sm:px-6 lg:px-8 py-10">
        ...
        <?php wc_get_template('components/featured-products.php'); ?>
    </section>
    ...
    <section class="mx-auto max-w-xl md:max-w-1440px px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div class="mt-10 md:grid md:grid-cols-4 md:gap-x-8">
            <div class="mb-10 block">
                <img src="<?php echo get_template_directory_uri() . '/assets/frontend/img/home/inox.webp' ?>" class="aspect-square w-full rounded-sm object-cover hover:opacity-75">
            ...
            <div class="mb-10 block">
                <img src="<?php echo get_template_directory_uri() . '/assets/frontend/img/home/vidros.webp' ?>" class="aspect-square w-full rounded-sm object-cover hover:opacity-75">
            ...
            <div class="mb-10 block">
                <img src="<?php echo get_template_directory_uri() . '/assets/frontend/img/home/laminas.webp' ?>" class="aspect-square w-full rounded-sm object-cover hover:opacity-75">
            ...
            <div class="mb-10 block">
                <img src="<?php echo get_template_directory_uri() . '/assets/frontend/img/home/paleta.webp' ?>" class="aspect-square w-full rounded-sm object-cover hover:opacity-75">
