...
<footer class="mt-8 bg-neutral-50">
    ...
    <?php wc_get_template('components/whatsapp-floating-button.php'); ?>
    ...
    <div class="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 xl:px-12">
                ...
                <div class="flex flex-col justify-center items-center md:items-start">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex flex-col items-center md:block">
                            ...
                            <a href="mailto:<?php echo esc_attr($email); ?>" class="underline hover:text-gold-500" role="button">
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="flex gap-4">
                    <?php if ($instagram_link) : ?>
                        <a href="<?php echo esc_url($instagram_link); ?>" target="_blank" rel="noopener" role="button" class="hover:text-neutral-800 hover:scale-110 transition ease-in-out duration-300">
                    ...
                    <?php if ($pinterest_link) : ?>
                        <a href="<?php echo esc_url($pinterest_link); ?>" target="_blank" rel="noopener" role="button" class="hover:text-neutral-800 hover:scale-110 transition ease-in-out duration-300">
                    ...
                    <?php if ($facebook_link) : ?>
                        <a href="<?php echo esc_url($facebook_link); ?>" target="_blank" rel="noopener" role="button" class="hover:text-neutral-800 hover:scale-110 transition ease-in-out duration-300">
                    ...
                    <?php endif; ?>
                    <?php if ($youtube_link) : ?>
                        <a href="<?php echo esc_url($youtube_link); ?>" target="_blank" rel="noopener" role="button" class="hover:text-neutral-800 hover:scale-110 transition ease-in-out duration-300">
        ...
        <div class="flex flex-col items-center justify-center border-t border-neutral-200 pt-8 text-center text-xs font-light text-neutral-500 sm:text-sm md:items-start">
            <?php
            if ($footer_text = get_option('sartorello_woo_theme_footer_text')) {
