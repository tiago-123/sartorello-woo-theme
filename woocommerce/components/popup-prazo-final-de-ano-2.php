    ...
    <div
        ...
        <div>
            <h2 class="flex flex-col items-center justify-center gap-1">
                <span class="text-xs sm:text-sm font-light tracking-wider">FINAL DE ANO</span>
                <span class="text-2xl sm:text-3xl font-light">AVISO IMPORTANTE</span>
            </h2>
        </div>
        ...
        <div class="px-6 space-y-3 text-sm font-light text-center">
            <p>Devido aos prazos de fabricação e transporte, bem como das festas de final de ano, gostaríamos de informar que os prazos estimados para entrega dos pedidos podem divergir daqueles informados no site.</p>
            <p>Se você deseja receber seu pedido antes do Natal, por favor, entre em contato conosco para confirmar a data de entrega.</p>
            <p>Agradecemos a sua compreensão e paciência durante este período. Estamos trabalhando com empenho para garantir que todos os pedidos sejam entregues o mais rápido possível.</p>
            <p>A Sartorello Móveis deseja um Feliz Natal e um próspero Ano Novo a todos os clientes! 🎄✨</p>
        </div>
