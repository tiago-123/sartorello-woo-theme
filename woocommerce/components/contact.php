...
<div
    ...
    class="fixed top-0 right-0 z-999999 flex h-full w-screen max-w-lg flex-col justify-start bg-white px-4 py-6 shadow-xl sm:px-6">

    <div class="flex items-center justify-between border-b border-neutral-200 pb-4">
        <h2 class="text-lg font-medium">Contato</h2>
        <button x-on:click="open = false" class="relative flex items-center justify-center ml-3 text-neutral-400 hover:text-neutral-600" type="button" aria-label="Fechar popup de contato">
    ...
    <div>
        <a role="button" href="<?php echo esc_url($whatsapp_link); ?>" target="_blank" class="flex items-center justify-center gap-1 w-full mt-4 px-8 py-3 text-sm text-green-600 hover:text-white hover:font-medium rounded-md border border-green-600 bg-green-50 hover:bg-green-600 shadow-md focus:outline-hidden">
