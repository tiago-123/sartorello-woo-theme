...
<a
    class="whatsapp-button flex items-center justify-center gap-1 w-full h-12 mt-4 px-8 py-3 text-sm text-green-600 hover:text-white hover:font-medium rounded-md border border-green-600 bg-green-50 hover:bg-green-600 focus:outline-hidden"
